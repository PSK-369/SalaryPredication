...
try:
    try:
        ...
        Logistic_classification = joblib.load(os.path.join(rootpath,"pages/logistic_regression.joblib"))
        Decision_classification = joblib.load(os.path.join(rootpath,
            "pages/DecisionTreeClassifier_instance.joblib"
        ))
        Random_classification = joblib.load(os.path.join(rootpath,"pages/RandomForestClassifier_Instance.joblib"))
        Knn_classification = joblib.load(os.path.join(rootpath,"pages/KNeighborsClassifier_instance.joblib"))
        Svc_classification = joblib.load(os.path.join(rootpath,"pages/SVCClassifier_instance.joblib"))
